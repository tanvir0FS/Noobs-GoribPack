...
try {
  ...
  fs.writeFileSync(path_toilet,imageBuffer);
   api.sendMessage({attachment: fs.createReadStream(path_toilet, {'highWaterMark': 128 * 1024}), body: "সঠিক জায়গায় সঠিক ছবি🐸"}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
